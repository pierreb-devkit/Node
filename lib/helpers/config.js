 ...
 * non-dev environments. A project-specific placeholder belongs in that
 * project's own config, not here — and a short secret is already rejected
 * by the length check in isJwtSecretWeak below regardless of this list.
 * @readonly
 */
